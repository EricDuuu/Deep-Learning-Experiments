...
for epoch in range(epochs):
    ...
    print('Epoch {}/{}: Train Loss {:.4f} | Val Loss {:.4f} | Val Acc {:.4f}'.format(epoch + 1, epochs, loss, val_loss, accuracy))
...
print('Test Loss: {:.4f}, Test Accuracy: {:.4f}'.format(test_loss, accuracy))